...
import br.com.pm73.dominio.LeilaoBuilder;
...
//		Leilao leilao = new Leilao("Diego", 100.00, dono, false);
//		Lance lance = new Lance(Calendar.getInstance(), dono, 100.0, leilao);
//				
//		Leilao montLeilao = new LeilaoBuilder().comDono(dono).comLance(lance)
//				.comLance(lance).constroi();
//		usuarioDao.salvar(dono);
//		usuarioDao.salvar(comprador);
//		leilaoDao.salvar(montLeilao);
//
